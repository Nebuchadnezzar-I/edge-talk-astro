...
import { A as AstroError, p as i18nNoLocaleFoundInPath, R as ResponseSentError, q as MiddlewareNoDataOrNextCalled, s as MiddlewareNotAResponse, G as GetStaticPathsRequired, t as InvalidGetStaticPathsReturn, u as InvalidGetStaticPathsEntry, v as GetStaticPathsExpectedParams, w as GetStaticPathsInvalidRouteParam, P as PageNumberParamNotFound, x as NoMatchingStaticPathFound, y as PrerenderDynamicEndpointPathCollide, z as ReservedSlotName, B as RewriteWithBodyUsed, L as LocalsNotAnObject, C as PrerenderClientAddressNotAvailable, H as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, J as AstroResponseHeadersReassigned } from './astro/assets-service_CfhXJX0c.mjs';
import { g as getActionQueryString, d as deserializeActionResult } from './shared_DAcLkIRN.mjs';
import 'es-module-lexer';
import { appendForwardSlash, joinPaths, trimSlashes, removeTrailingForwardSlash } from '@astrojs/internal-helpers/path';
import { l as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, o as renderSlotToString, p as renderJSX, q as chunkToString, t as isRenderInstruction, u as originPathnameSymbol, R as ROUTE_TYPE_HEADER, i as clientLocalsSymbol, j as clientAddressSymbol, A as ASTRO_VERSION, n as responseSentSymbol$1, v as renderPage, w as REWRITE_DIRECTIVE_HEADER_KEY, x as REWRITE_DIRECTIVE_HEADER_VALUE, y as renderEndpoint } from './astro/server_B0OQd9WE.mjs';
import 'clsx';
import 'kleur/colors';
import { D as DEFAULT_404_ROUTE } from './astro-designed-error-pages_BBNLGixv.mjs';
